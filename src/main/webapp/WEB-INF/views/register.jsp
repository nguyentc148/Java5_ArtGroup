		...
		<form action="login" method="post" class="w-100">
			<div class="card-login p-5">
				...
				<div class="inputBox">
					...
					<span class="user">Họ tên:</span>
				</div>

				<div class="inputBox">
					<input type="email" required="required" autocomplete="none">
				...
				<div class="inputBox">
					<input type="password" required="required"> <span>Nhập lại mật
						khẩu</span>
				</div>
				<div class="check">
				...
				<span>BẠN LÀ THÀNH VIÊN, ĐĂNG NHẬP <a
					href="/login" class="btnLogin"><u>TẠI ĐÂY.</u></a></span>
			</div>
		</form>
