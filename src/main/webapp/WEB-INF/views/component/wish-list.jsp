...
<div class="content-profile">
	<div
		...
		<span class="display-6">Danh sách sản phẩm yêu thích</span>
	</div>
	<div class="filter-listProduct p-3 mt-3">
		<div class="row">
			<div class="col-12 col-md-12 col-lg-2">
				<span class="fw-bold fs-5"><i class="bi bi-funnel"></i>Bộ lọc
					|</span>
			</div>
					...
					<ul class="dropdown-menu p-2" aria-labelledby="dropdownMenuButton2">
						...
						<c:forEach begin="1" end="5" varStatus="i">
							<li class="px-4"><input
								class="form-check-input filter-checkbox brand-checkbox"
								type="checkbox" value="${mn.manufacturer_name }" id="${i.index}">
								<label class="form-check-label" for="${i.index}">${mn.manufacturer_name}vidu2</label></li>
						</c:forEach>
					</ul>
				</div>
			</div>
			<div class="col-4 col-md-4 col-lg-2">
				<div class="dropdown">
					...
					<ul class="dropdown-menu p-2" aria-labelledby="dropdownMenuButton3">
						<li class=""><input
			...
			<div class="col-4 col-md-4 col-lg-2">
				<select class="form-select fw-bold " id="sort-select"
